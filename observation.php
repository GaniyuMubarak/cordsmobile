            ...
            <div class="container">
                <div class="breadcrumbs position-relative">
                    <div class="breadcrumbs-wrap">
                        <h1 class="title">Observation Station</h1>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="wrap-title-solution style">
                            <div class="content">
                                <div class="inner">
                                    <button class="btn btn-success m-5 border-corner p-4" style="font-size:20px;" id="showHidden">Click Here for observation</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12 mb-5">
                        <div class="swiper-leadteam swiper-container">
                            ...
                            <form action="controller/registerController.php" style="width:50%; margin:auto;" method="post">
                              <div>
                                <input type="text" name="observation" value ="<?php if(isset($_SESSION["email"])){echo $_SESSION["email"];}?>" id="textHidden1" placeholder="Enter your Email Address" style="color:black" class="d-none" readonly>
                              </div>
                              <br>
                               <textarea name="message" id="textHidden2" cols="20" rows="15" placeholder="Enter your what you observe here!" style="color:black" class="d-none"></textarea>
                               <input type="submit" value="Submit" name="observationButton" id="submitHidden" class="d-none mt-3">
                            </form>
                            </div>
                        </div>
                    </div>
